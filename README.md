...
Nash Agent — это локальный помощник менеджеров продукта для моделирования продуктовой стратегии или отдельных фичей по теории игр Джона Нэша. Продуктовый кейс он собирает в компактную многопользовательскую игровую модель, прогоняет до 64 возможных сценариев и помогает оценить, насколько запуск стратегически устойчив до начала разработки.
